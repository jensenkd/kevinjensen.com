...
/* custom function VEGAS Home Slider */
	function loadVegas(){
		$.vegas('slideshow', {
			  backgrounds:[
				{ src:'assets/img/homebg3.jpg' },
				{ src:'assets/img/homebg5.jpg' },
				{ src:'assets/img/homebg8.jpg' },
			  ]
			})('overlay', {
...
$(window).load(function() {
	...
	$('.socket').addClass('animated fadeOut');	
	  ...
	  setTimeout(function() {
		  ...
		  setTimeout(function() {
			  $('#home-screen .home_title').addClass('animated fadeInDown');
					  ...
					  setTimeout(function() {
						  ...
						  setTimeout(function() {
							  ...
							  setTimeout(function() {
								  ...
								  $('#home-screen .home_title').css('opacity','1');
